...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{@{}p{2.6cm} p{3.2cm} p{2.4cm} p{1.8cm} X@{}}
			...
			VET-06 & Técnico (veterinario) & Pendiente de verificación$^{\dagger}$ & Pendiente de verificación$^{\dagger}$ & RF-01 a RF-17 (conjunto completo) \\
	...
	{\footnotesize $^{\dagger}$La duración y fecha exactas de la sesión de
		VET-06 (EV-22) no se registraron en la ficha resumen disponible en la
		zona pública; el acta firmada en PDF (Apéndice~B.9) confirma la sesión y
		el alcance de la validación, y el dato pendiente debe completarse desde
		el archivo original antes del corte final.}
	...
	fecha de la Entrega 3 (2A) el volumen se fragmentaba en 67 partes
	(\texttt{evidencias\_restringidas.7z.001} a
	\texttt{evidencias\_restringidas.7z.067}); con la incorporación de los
	archivos originales de EV-23 y EV-24 en la revisión 4.0, el volumen cifrado
	debe regenerarse con las partes adicionales correspondientes antes del
	corte final, lo cual queda pendiente de ejecución técnica fuera del alcance
	de esta revisión documental. La contraseña del
