...
\begin{document}
	...
	una clasificación de riesgo y un plan de monitoreo en producción,
	detallados en la Sección~\ref{sec:equidad-riesgo-ia}.
...
equidad, su clasificación de riesgo y su plan de monitoreo en producción,
de modo que ningún componente de IA quede solo declarado sin una
especificación medible de estos tres aspectos.
...
\begin{itemize}[leftmargin=*]
	...
	significativa ($p=0{,}0001$; Sección \ref{sec:resultados}).
