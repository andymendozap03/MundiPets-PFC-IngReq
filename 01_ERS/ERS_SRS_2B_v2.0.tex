...
\begin{document}
	...
	\begin{atributos}{RNF-12}{RNF-12 --- Escalabilidad ante crecimiento de usuarios.}
		...
		Descripción & El sistema deberá soportar el incremento de usuarios concurrentes sin degradar significativamente el tiempo de respuesta definido en \hyperref[tab:RNF-03]{RNF-03}, permitiendo escalar horizontalmente los servidores de aplicación. \\
	...
	\begin{atributos}{RNF-15}{RNF-15 --- Explicabilidad de la moderación de mensajes.}
		...
		Característica ISO 25010 & Interacción de usuario (Explicabilidad) \\
		Descripción & Cuando un mensaje sea reportado por un usuario conforme al mecanismo de reporte manual de \hyperref[tab:RF-07]{RF-07}, el sistema deberá notificar al remitente la categoría del motivo señalado (lenguaje ofensivo, spam o acuerdo externo indebido) mediante una explicación por ejemplos. \\
