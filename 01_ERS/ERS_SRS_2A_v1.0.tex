...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{@{}c X c@{}}
			...
			4 & Todos los archivos multimedia siguen la nomenclatura \texttt{YYYY-MM-DD\_Tipo\_CodigoParticipante\_Tecnica.ext} y usan el código de participante, no el nombre propio. & $\square$ \\
	...
	\textbf{Nota sobre los ítems no marcados.} Los ítems 1, 2, 4, 11 y 12 no se
	consideran cumplidos a la fecha de esta versión: el árbol del repositorio
	presenta desviaciones respecto de la estructura obligatoria, el archivo
	\texttt{checksums.sha256} está pendiente de generación, la nomenclatura de
	los archivos multimedia aún emplea el nombre propio en lugar del código de
	participante, y los artefactos de trazabilidad y priorización en formato CSV
	no se han versionado todavía en \texttt{04\_Trazabilidad/}. El equipo
	declara estos pendientes de forma expresa en lugar de autocertificarlos, y
	su resolución constituye la prioridad inmediata antes del corte.
