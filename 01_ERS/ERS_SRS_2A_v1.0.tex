...
\begin{document}
	...
	\url{https://osf.io/zr2s7/overview?view_only=545c488adaf64b99b254adde0e6cb7a5}.
	Al momento de redactar esta sección, el registro se encuentra en estado
	\emph{pendiente de aprobación} (moderación estándar de OSF posterior al
	envío); esto no afecta la validez de la marca de tiempo, ya que el
	contenido del registro queda congelado desde el momento del envío, con
	independencia de su posterior aprobación.
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{@{}p{2.6cm} p{3.2cm} p{2.4cm} p{1.8cm} X@{}}
			...
			\midrule
			Mayerli Vélez & Técnico (veterinaria) & 12:09 min & 27/07/2026 & RF-01 a RF-06, RF-08 \\
			Lesly Flores & No técnico (propietaria) & 16:11 min & 27/07/2026 & RF-01 a RF-06, RF-08, RF-11 \\
			Johan Alcivar & No técnico (propietario) & 25:40 min & 27/07/2026 & RF-01 a RF-17 (conjunto completo) \\
			\bottomrule
		\end{tabularx}
	\end{table}
	...
	EV-18 se almacenan en \texttt{02\_Evidencias/}, organizados por técnica de
	elicitación y nombrados con el patrón \texttt{EV-XX\_tecnica\_fecha}. Todos
	...
	(Sección~\ref{sec:moscow}), su clasificación Kano (pendiente de la segunda
	ronda de campo, Sección~\ref{sec:kano}) y su valor WSJF estimado en equipo
	...
	\begin{landscape}
		\begin{longtable}{@{}p{1.2cm} p{5.2cm} p{1.0cm} p{1.3cm} p{1.3cm} p{1.1cm} p{6.5cm}@{}}
			...
			RF-01 & Registrar mascota & RF & Must & --- & 9,20 & Es el pilar del sistema; sin este RF no puede existir ningún perfil de mascota ni proceso posterior. \\ \midrule
			RF-02 & Gestionar historial médico & RF & Must & --- & 3,63 & Crítico para la salud animal y para RL-03 (rectificación de datos médicos). \\ \midrule
			RF-03 & Consultar perfil completo & RF & Must & --- & 8,67 & Fundamental para que adoptantes e interesados en cruza tomen decisiones informadas; sustenta RL-02. \\ \midrule
			RF-04 & Buscar y filtrar mascotas & RF & Should & --- & 1,80 & Mejora la usabilidad, pero el sistema puede operar inicialmente con listas generales. \\ \midrule
			RF-05 & Gestionar solicitudes de adopción & RF & Must & --- & 3,63 & Núcleo del modelo operativo de la plataforma. \\ \midrule
			RF-06 & Evaluar compatibilidad para cruza & RF & Must & --- & 1,65 & Requisito diferenciador que usa IA; motivó RD-01 y exige la explicabilidad de RL-06. \\ \midrule
			RF-07 & Sistema de mensajería & RF & Could & --- & --- & Deseable para coordinar procesos, pero el contacto inicial puede derivarse a canales externos si hay limitaciones de tiempo. \\ \midrule
			RF-08 & Gestionar solicitudes de cruza & RF & Must & --- & 2,88 & Operación central del modelo de negocio junto a RF-05. \\ \midrule
			RF-09 & Validar información médica & RF & Must & --- & 4,20 & Imprescindible para la confiabilidad clínica del sistema. \\ \midrule
			...
			RF-12 & Verificar identidad de usuarios & RF & Must & --- & 5,80 & Indispensable para evitar fraude; sustenta el consentimiento de RL-01. \\ \midrule
			...
			RF-14 & Gestionar carnet de vacunación & RF & Must & --- & 4,20 & Crítico para la trazabilidad sanitaria; sustenta RL-03. \\ \midrule
			...
			RF-24 & Trazabilidad de cepa, lote y aplicador & RF & Should & --- & 2,67 & Complementa RF-14 con datos adicionales de trazabilidad, no bloqueante. \\ \midrule
			...
			RD-03 & Validación profesional de la información médica & RD & Must & --- & --- & Exigido por los veterinarios entrevistados para garantizar confiabilidad clínica. \\ \midrule
	...
	con el archivo \texttt{04\_Trazabilidad/matriz\_trazabilidad.csv}. La matriz alcanza las 40 filas
	exigidas: las diez filas finales (TR-31 a TR-40) recogen las relaciones
	derivadas de los RF-18 a RF-25, del RNF-16 y del RD-09 incorporados en esta
	entrega.
	...
	\begin{landscape}
		\begin{longtable}{@{}p{0.8cm} p{1.3cm} p{1.5cm} p{2.2cm} p{1.5cm} p{1.8cm} p{1.6cm} p{1.3cm} p{1.3cm} p{1.3cm} p{1.5cm}@{}}
			...
			TR-02 & LOPDP & --- & Registro clínico & Veterinaria & EV-01, EV-04 & RF-02 & CU-02 & HU-02 & CA-02 & --- \\ \midrule
			
			TR-03 & LOPDP & --- & Consulta de perfil médico & Adoptante & EV-04, EV-06, EV-08 & RF-03 & CU-10 & HU-03 & CA-03 & --- \\ \midrule
			
			TR-04 & --- & --- & Búsqueda de mascotas & Adoptante & EV-07, EV-08 & RF-04 & CU-11 & --- & --- & --- \\ \midrule
			
			TR-05 & --- & --- & Publicación en adopción & Propietario & EV-01, EV-02, EV-03, EV-08 & RF-05 & CU-04 & HU-04 & CA-04 & --- \\ \midrule
			
			TR-06 & --- & --- & Evaluación de compatibilidad & Interesado en cruza & EV-04, EV-05, EV-06, EV-08 & RF-06 & CU-13 & HU-05 & CA-05 & --- \\ \midrule
			
			TR-07 & LOPDP & --- & Mensajería entre usuarios & Propietario & EV-02, EV-07, EV-08 & RF-07 & CU-08 & --- & --- & --- \\ \midrule
			
			TR-08 & --- & --- & Solicitudes de cruza & Interesado en cruza & EV-01, EV-03, EV-05 & RF-08 & CU-05 & HU-06 & CA-06 & --- \\ \midrule
			
			TR-09 & --- & --- & Validación de información médica & Veterinaria & EV-03, EV-05, EV-07 & RF-09 & CU-09 & HU-07 & CA-07 & --- \\ \midrule
			
			TR-10 & --- & --- & Controles preventivos & Propietario & EV-02, EV-04, EV-06 & RF-10 & CU-12 & --- & --- & --- \\ \midrule
			
			TR-11 & LOPDP & --- & Administrar privacidad & Propietario & EV-02, EV-05, EV-06, EV-07, EV-08 & RF-11 & CU-06 & HU-08 & CA-08 & --- \\ \midrule
			
			TR-12 & LOPDP & --- & Verificar identidad & Todos los usuarios & EV-01, EV-03, EV-07, EV-08 & RF-12 & (Transversal a Onboarding) & HU-09 & CA-09 & --- \\ \midrule
			
			TR-13 & --- & --- & Registrar publicaciones & Propietario / Refugio & EV-01, EV-02, EV-07, EV-08 & RF-13 & CU-04 & HU-10 & CA-10 & --- \\ \midrule
			
			TR-14 & --- & --- & Carnet de vacunación & Veterinaria & EV-03, EV-05, EV-07 & RF-14 & CU-03 & HU-11 & CA-11 & --- \\ \midrule
			
			TR-15 & --- & --- & Historial de procesos & Propietario & EV-01, EV-02, EV-04, EV-06 & RF-15 & CU-07 & --- & --- & --- \\ \midrule
			
			TR-16 & --- & --- & Antecedentes genéticos & Interesado en cruza & EV-01, EV-03, EV-05, EV-07 & RF-16 & CU-02 & HU-12 & CA-12 & --- \\ \midrule
			...
			TR-32 & LOPDP & Art. 12 & Validación de certificados veterinarios & Veterinaria & EV-11 & RF-19 & CU-09 & --- & --- & --- \\ \midrule
			...
			TR-40 & LOPDP & Art. 30--32 & Anonimización de evidencias de campo & Equipo investigador & EV-01 a EV-18 & RD-09 & (Transversal a Datos) & --- & --- & --- \\
	...
	El trabajo del equipo se versiona en el repositorio público
	...
	organización sigue el orden de las entregas de la asignatura y cada carpeta
	...
	\begin{lstlisting}[style=csharp,caption={Estructura de carpetas del repositorio MundiPets-PFC-IngReq.},label={lst:estructura_repo}]
		...
		|-- 01_ERS/
		|   |-- ERS_SRS_2A_v1_2.tex        % documento maestro
		|   |-- referencias.bib            % 41 fuentes primarias
		|   |-- figuras/                   % diagramas i*, UML y mockups
		|   `-- ERS_SRS_2A_v1_2.pdf        % compilado de la entrega
		|-- 02_Evidencias/
		|   |-- Entrevistas/               % actas firmadas (B.3)
		|   |-- Cuestionarios/             % exportaciones v2.0 (B.4)
		|   |-- Observacion/               % registros de campo (B.5)
		|   |-- Consentimientos/           % formularios firmados (B.6)
		|   |-- Validacion_Walkthrough/    % ronda de validacion (B.7)
		|   `-- Codificacion/              % curva de saturacion (B.8)
		|-- 03_Corpus/
		|   |-- corpus_RF_MundiPets_2A.json  % 25 RF etiquetados, CC BY 4.0
		|   `-- README_dataset.md            % metadatos FAIR y licencia
		|-- 04_Trazabilidad/
		|   |-- matriz_trazabilidad.csv    % 40 filas, diez eslabones
		|   `-- priorizacion_moscow_kano.csv
		|-- 05_MVP/
		|   |-- README.md                  % instrucciones de despliegue
		|   |-- src/                       % codigo fuente del MVP
		|   `-- video_demo.mp4             % evidencia de funcionamiento
		|-- 06_Experimento/
		|   |-- protocolo.pdf              % protocolo registrado en OSF
		|   |-- instrumentos/              % plantillas de anotacion
		|   `-- scripts_analisis/          % scripts de kappa y estadistica
		`-- README.md                      % descripcion general del proyecto
	\end{lstlisting}
	
	El archivo \texttt{03\_Corpus/corpus\_RF\_MundiPets\_2A.json} contiene los 25
	requisitos funcionales de la Sección~\ref{sec:rf} serializados con los once
	atributos del esquema de la plantilla (identificador, nombre, descripción,
	actor, origen de evidencia, entradas, salidas, precondiciones,
	postcondiciones, prioridad MoSCoW y criterio de verificación). Este archivo
	es el insumo directo del detector automático de ambigüedad descrito en la
	Sección~\ref{sec:empirico} y se deposita en Zenodo bajo licencia CC BY 4.0
	con DOI persistente, conforme a los principios FAIR \cite{wilkinson2016}.
	
	\subsection*{Historial de commits}
	
	El historial completo de commits, con autoría por integrante, se consulta en
	la pestaña \emph{Commits} del repositorio. El equipo mantiene mensajes de
	commit en formato convencional (\texttt{docs(ers): \dots},
	\texttt{feat(mvp): \dots}), de modo que la contribución individual de cada
	integrante sea verificable para la evaluación de la asignatura.
